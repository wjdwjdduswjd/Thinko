...
<body>
    ...
    <div class="login">
      ...
      <br>
        <img src="${contextPath}/resources/images/searchPw.png" width="150px" height="150px">
  
  <br>
  <br>
  <form accept-charset="UTF-8" role="form" method="post" action="searchPwdChange.do" onsubmit="return validate()">
  <div class="input">
    <div class="input-group">
    <input type="hidden" name="code" value="${param.code}">
      <i class="icon-envelope-alt"></i>
      <input type="password" id="newPw" name="newPw" placeholder="새 비밀번호를 입력하세요" class="form-control" />

    </div>
    
    <div class="input-group">
      <i class="icon-unlock"></i> 
     <input type="password" id="checkNewPw" class="form-control" placeholder="비밀번호를 한번 더 입력하세요" />
    </div>
</div>
    
   <button type="submit" id="changePw-submit" class="changePwbtn btn-default btn-block">Change PW</button>
...
<a href="${contextPath}/member2/searchIdForm.do">아이디찾기</a> | <a href="${contextPath}/member2/searchPwForm.do">비밀번호 찾기</a> | <a href="${contextPath}/member/joinForm.do">회원가입</a>
	...
	<script>
		...
		function validate(){
			...
			}else if($("#newPw").val() != $("#checkNewPw").val()){
				swal({icon: "warning" , title: "비밀번호가 일치하지 않습니다."});
				return false;
			}
		}
