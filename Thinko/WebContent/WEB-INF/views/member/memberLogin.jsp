...
<body>
    ...
    <br>
    	<a href="${contextPath}">
        <img src="${contextPath}/resources/images/loginLogo.png" width="250px" height="70px">
        </a>
    <p>This will be an amazing experience</p>

    <form method="POST" action="${contextPath}/member2/memberLogin.do">
      <div class="input">
        <div class="blockinput">
          <i class="icon-envelope-alt"></i><input type="text" name="userId" id="userId" placeholder="userId" value="${cookie.saveId.value }" required><br>
    
        </div>
        <div class="blockinput">
          <i class="icon-unlock"></i><input type="password" name="userPwd" id="userPwd" placeholder="Password" required><br>
        </div>
      </div>
