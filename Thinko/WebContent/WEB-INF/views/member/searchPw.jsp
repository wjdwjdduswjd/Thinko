...
<body style="background:rgba(232, 190, 240, 0.37);">
  ...
  <br>
  <br>
  <form accept-charset="UTF-8" role="form" method="POST" action="${contextPath}/member2/searchPw.do">
  <div class="input">
    <div class="input-group">
      <i class="icon-envelope-alt"></i>
      <input type="text" id="name" name="memberId" placeholder="userID" class="form-control" />

    </div>
    
    <div class="input-group">
      <i class="icon-unlock"></i> 
      <input type="email" id="password" name="memberEmail" placeholder="userEmail" class="form-control" />
    </div>
</div>
      <small>가입 시 입력한 이메일을 기재해주세요.</small>
    <button type="submit" id="password-submit" class="btn btn-default btn-block">Find PW</button>
